...
@st.cache_resource
def load_models():
    yolo_model = YOLO("model/Adila Khairunnisa_Laporan 4.pt")  # YOLO model
    classifier = tf.keras.models.load_model("model/Adila Khairunnisa_Laporan 2.h5", compile=False)  # CNN model
